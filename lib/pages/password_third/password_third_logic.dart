...
import 'package:app_password/pages/password_first/password_first_logic.dart';
...
class PasswordThirdLogic extends GetxController {
  ...
  cleanPWData() async {
    Get.dialog(AlertDialog(
      ...
      actions: [
        ...
        TextButton(
          onPressed: () async {
            await dbPW.cleanPasswordData();
            PasswordFirstLogic passwordFirstLogic = Get.find<PasswordFirstLogic>();
            passwordFirstLogic.getData();
            Get.back();
          },
          child: const Text(
            'OK',
  ...
  aboutPWPrivacy(BuildContext context) async {
...
If you have any questions or concerns about our privacy policy, please contact us via email.
  ...
  aboutPWUS(BuildContext context) async {
    ...
    showAboutDialog(
      ...
      children: [
        const Text(
            """We can record the password for you"""),
      ],
      context: context,
    );
  }
